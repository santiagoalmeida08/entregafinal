...
h2['state_name'] = h2['state_name'].apply(lambda x: x.lower())
...
with panel1:
    ...
    with g2:
        fig = px.line(state_datos, x='year', y='prom_crimenes',  width=1100, height=450)
...
#LINK ARCHIVO GEOJSON: 
#Archivo geojson division por estado https://github.com/deldersveld/topojson/blob/master/countries/united-states/us-albers.json
...
if est2 == 'All crimes' : 
    g1 = px.bar(zf, x='state_name', y='cantidad',width=1700, height=450)
    ...
    g2 = px.bar(zfprop, x='state_name', y='cantidad',width=1700, height=450)
    ...
    g3 = px.bar(zfvio, x='state_name', y='cantidad',width=1700, height=450)
    ...
    g4 = px.bar(zfhom, x='state_name', y='cantidad',width=1700, height=450)
    ...
    g5 = px.bar(zfrap1, x='state_name', y='cantidad',width=1700, height=450)
    ...
    g5 = px.bar(zfrap2, x='state_name', y='cantidad',width=1700, height=450)
    ...
    g5 = px.bar(zfrob, x='state_name', y='cantidad',width=1700, height=450)
    ...
    g5 = px.bar(zfagg, x='state_name', y='cantidad',width=1700, height=450)
    ...
    st.plotly_chart(g5)
     ...
     g5 = px.bar(zfbur, x='state_name', y='cantidad',width=1700, height=450)
     ...
     g5 = px.bar(zflar, x='state_name', y='cantidad',width=1700, height=450) 
     ...
     g5 = px.bar(zfmot, x='state_name', y='cantidad',width=1700, height=450)
